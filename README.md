...
|---|---|---|
| HTTP | `cx.get / cx.post / cx.put / cx.patch / cx.delete / cx.request (builder) / cx.upload / cx.download (streaming)` | headers + byte body/response; streaming upload/download with progress + cancel (native shells land in CLI 0.49) |
