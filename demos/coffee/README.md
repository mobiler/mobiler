...
- **Plugin demos** on the detail screen (added with `mobiler plugin add`): **Scan a code** (scanner — barcode/QR), **Lock test** (biometric auth + securestore), **WS echo** (websocket round-trip), **Remind me** (notifications — local scheduled)
