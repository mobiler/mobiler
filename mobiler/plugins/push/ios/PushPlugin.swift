...
//   cx.subscribe("push", "push", "events", "", |r| Msg::PushEvent(r)) // payloads tagged "mobiler_push":"received"|"opened"
//
...
// AppDelegate forwards to PushBridge; `subscribe` attaches an emit sink to PushBridge (which tags each
// notification "received" or "opened", and buffers a tap that arrived before the core subscribed).
//
