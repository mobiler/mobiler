...
a plugin→core streaming/events
...
(`mobiler_core::format`), a device-locale getter (`cx.device_locale`), and an in-app PDF viewer
(`PdfView`). Next up: lazy/virtualized lists._
