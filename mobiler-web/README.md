...
with [Leptos](https://leptos.dev) (CSR/WASM), and fulfils the built-in capabilities
...
- **Complete widget coverage.** Every [`mobiler-ui`](https://crates.io/crates/mobiler-ui)
  ...
  (bar/line/stacked/pie/donut/rings/gauge + region/coverage), drawn with SVG + CSS here, the
  **video player** / **web view** / **PDF viewer**, and an interactive **map** (MapLibre-GL).
